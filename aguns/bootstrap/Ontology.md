# Ontology (Bootstrap Agun)

Type: Concept × Long-term

This agun describes the core ontology used by Taconem.

Taconem uses a 2×2×2 model for aguns along three axes:
...
This ontology guides how new aguns should be created and categorized.
